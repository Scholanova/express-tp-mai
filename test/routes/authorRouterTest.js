...
describe('authorRouter', () => {
  ...
  describe('list', () => {
    ...
    context('when there are authors without pseudo', () => {
      ...
      it('should return an html list with author without empty ()', () => {
        // then
        expect(response).to.be.html
        expect(response.text).to.not.contain(`${author.name} ()`)
      })
    })
  })
  ...
  describe('show', () => {
    ...
    context('when there is an author matching in the repository without pseudo', () => {
